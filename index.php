...
<html lang="zxx">
							...
							<div class="sidebar-modal-widget">
								...
								<ul class="contact-info">
									...
									<li>
										...
										Email
										<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6e060b0202012e1e1c0b180114400d0103">[email&#160;protected]</a></span>
									</li>
									<li>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						...
						if(isset($_REQUEST["loginbtn"])){
							...
							echo "dear $fname, your $email and $gender are respectively , your hobbies include $hobbies and your location is $address ";
						}
						?>
					</div>
					<div class="col-lg-6">
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group">
											<input class="form-control" type="text" name="fname" placeholder=" Input Your Full Name " required>
										</div>
										<div class="col-12">
										<div class="form-group">
											<input class="form-control" type="email" name="email" placeholder="Input Your email" required>
										</div>
									</div>
									<div class="col-12">
										<div class="form-group">
											<input class="form-control" type="text" name="address" placeholder="Enter Home Address" required>
										</div>
									</div>
									
									<select class="form-selects" name="gender" size="1" aria-label="size 3 select example">
  ...
  <label class="form-check-label" for="inlineCheckbox1" name="hobbies">Reading</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Sleeping">
  <label class="form-check-label" for="inlineCheckbox2" name="hobbies">Sleeping</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Dancing" >
  <label class="form-check-label" for="inlineCheckbox3" name="hobbies">Cooking</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Jumping" >
  <label class="form-check-label" for="inlineCheckbox3" name="hobbies">Jumping</label>
</div>
									</div>
									
									<div class="col-lg-6 col-sm-6 mt-3">
									<button class="default-btn btn-two" type="submit" name="loginbtn">
											Log In Now
											<i class="flaticon-right"></i>
										</button>
									</div>
				...
				<div class="testimonials-wrap owl-carousel owl-theme">
					<div class="single-testimonials">
						...
						<div class="testimonials-content">
							...
							<h4>Ayman Jenis</h4>
							<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bcfff9f3fcf0d9ddcfc9d9d0c5">[email&#160;protected]</a></span>
						</div>
					</div>
					<div class="single-testimonials">
						<ul>
						...
						<div class="testimonials-content">
							...
							<h4>Ayman Jenis</h4>
							<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="db989e949b97bebaa8aebeb7a2">[email&#160;protected]</a></span>
						</div>
					</div>
					<div class="single-testimonials">
						<ul>
						...
						<div class="testimonials-content">
							...
							<h4>Ayman Jenis</h4>
							<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1251575d525e77736167777e6b">[email&#160;protected]</a></span>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="single-widget">
								...
								<ul class="information">
									...
									<li class="address">
										...
										<span>Email</span>
										<a href="/cdn-cgi/l/email-protection#d3bbb6bfbfbc93b6b0bca1bab8fdb0bcbe">
											<span class="__cf_email__" data-cfemail="80e8e5ececefc0e5e3eff2e9ebaee3efed">[email&#160;protected]</span>
										</a>
									</li>
								</ul>
							</div>
