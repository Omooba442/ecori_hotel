...
<html lang="zxx">
    ...
    <body>
		...
		<header class="header-area">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-3 col-sm-1">
							<div class="header-logo">
								<a href="index-2.html">
									<img src="assets/img/home-two/logo.png" alt="Image">
								</a>
							</div>
						</div>
			...
			<div class="eorik-nav-style eorik-nav-style-two">
									...
									<ul class="navbar-nav mr-auto">
										...
										<li class="nav-item">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item">
													<a href="room-list-view.html" class="nav-link">Room List View</a>
												</li>
												<li class="nav-item">
													<a href="room-block-view.html" class="nav-link">Room Block View</a>
												</li>
												<li class="nav-item">
		...
		<!-- Start Ecorik Banner Area -->
		<section class="ecorik-banner-area jarallax">
			<div class="d-table">
				<div class="d-table-cell">
					<div class="container">
						<div class="ecorik-banner-text">
							<h1>Make Memories</h1>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="explore-content mr-30">
							...
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt eveniet reprehenderit ratione ad perspiciatis repudiandae iste ipsam temporibus sit quo! Incidunt, necessitatibus fugiat ut dignissimos pariatur odit natus ipsum! Obcaecati iste ipsam temporibus sit quo! Incidunt, necessitatibus Obcaecati iste.</p>
		...
		<section class="city-view-area city-view-area-two pt-140 jarallax">
			<div class="container">
				<div class="city-wrap">
		...
		<section class="our-rooms-area-two pb-70">
			<div class="container">
				<div class="section-title">
					<span>Our Rooms</span>
		...
		<!-- End Incredible Area -->
		<section class="incredible-area incredible-area-two ptb-140 jarallax">
			<div class="container">
		...
		<section class="exclusive-offers-area ptb-140 jarallax">
			<div class="container">
				<div class="section-title">
					<span>Exclusive Offers</span>
					<h2>You can get an exclusive offer</h2>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
						<div class="exclusive-content mb-0">
		...
		<section class="testimonials-area-two pt-60 pb-100">
			<div class="container">
				<div class="section-title">
					<span>Testimonials</span>
					<h2>What customers say</h2>
				</div>
				<div class="testimonials-wrap-two">
					<div id="sync1" class="owl-carousel owl-theme">
						<div class="item">
							<div class="single-testimonials">
								...
								<p>“Hotel  ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat veniam, quis nostrud exercitation enim ad minim consectetur”</p>
							</div>
						</div>
						<div class="item">
							<div class="single-testimonials">
					...
					<div id="sync2" class="owl-carousel owl-theme">
						<div class="item">
							<div class="testimonials-content">
								...
								<h4>Ayman Jenis</h4>
								<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dc9f99939c90b9bdafa9b9b0a5">[email&#160;protected]</a></span>
							</div>
						</div>
						<div class="item">
							<div class="testimonials-content">
		...
		<!-- End Testimonials Two Area -->

		<!-- Start Slider Gallery Area -->
		<div class="slider-gallery-area pb-100">
							...
							<div class="single-widget">
								...
								<ul class="information">
									...
									<li class="address">
										...
										<span>Email</span>
										<a href="/cdn-cgi/l/email-protection#452d2029292a0520262a372c2e6b262a28">
											<span class="__cf_email__" data-cfemail="771f121b1b1837121418051e1c5914181a">[email&#160;protected]</span>
										</a>
									</li>
								</ul>
							</div>
