...
<html lang="zxx">
    ...
    <body>
					...
					<nav class="navbar navbar-expand-md navbar-light">
						<div class="container">
							<a class="navbar-brand" href="index.html">
								<img src="assets/img/home-four/logo.png" alt="Logo">
							</a>
							...
							<div class="sidebar-modal-widget">
								...
								<ul class="contact-info">
									...
									<li>
										...
										Email
										<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b6ded3dadad9f6d3d5d9c4dfdd98d5d9db">[email&#160;protected]</a></span>
									</li>
									<li>
		...
		<section class="eorik-slider-area eorik-slider-area-four">
		...
		<!-- End Restaurants Area Four -->
		<section class="restaurants-area-four ptb-100">
			<div class="container">
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="restaurants-content">
							<h2>Area those have covered </h2>
							<p class="r-p-m">All area  view onin wansis dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliquat nim ad minim veniam, quis nostrud exercitation.</p>
							<div class="row">
								<div class="col-lg-4 col-sm-6">
									<div class="singles-restaurants custom">
										<i class="flaticon-coffee-cup"></i>
										<h3>Restaurant</h3>
										<p>parkn ipsum dolor sit amet, consectetur adiing</p>
										<a href="about.html" class="icon-btn">
											<i class="flaticon-right"></i>
										</a>
									</div>
								</div>
					...
					<div class="col-lg-6">
						<div class="row restaurants-img-height">
							<div class="col-lg-6">
								<div class="restaurants-img-1">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="restaurants-img-2">
								</div>
							</div>
						</div>
					</div>
		...
		<section class="city-view-area city-view-area-four ptb-100 jarallax">
			<div class="container">
				<div class="city-wrap">
					<div class="single-city-item owl-carousel owl-theme">
						<div class="city-view-single-item">
							<div class="city-content">
								...
								<p>The view onin wansis dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ad minim veniam, quis nostrud exercitation.</p>
							</div>
						</div>
						<div class="city-view-single-item">
							<div class="city-content">
				...
				<div class="row">
					<div class="col-lg-4 col-sm-6">
						<div class="single-exclusive-four">
							<img src="assets/img/exclusive/7.jpg" alt="Image">
							<div class="exclusive-content">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-exclusive-four">
							<img src="assets/img/exclusive/8.jpg" alt="Image">
							<div class="exclusive-content">
					...
					<div class="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0">
						<div class="single-exclusive-four">
							<img src="assets/img/exclusive/9.jpg" alt="Image">
							<div class="exclusive-content">
		...
		<!-- Start Customer Area -->
		<section class="customer-area customer-area-four pt-100 jarallax">
			<div class="container">
				<div class="customer-wrap-four owl-carousel owl-theme">
					<div class="single-customer">
						<img src="assets/img/testimonials/4.jpg" alt="Image">
						<h3>Awesome Quality Service</h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque animi voluptatum repudiandae exercitationem, deserunt, perferendis a sequi maiores reprehenderit quaerat</p>
		...
		<!-- End News Area -->
		<section class="news-area news-area-four pt-100 pb-60">
			<div class="container">
				<div class="section-title">
					<span>Our BLog</span>
				...
				<div class="news-wrap-slider owl-carousel owl-theme">
					<div class="single-news">
						<div class="row">
							<div class="col-lg-6 pr-0">
								<div class="news-img  bg-1">
									<div class="dates">
										<span>HOTEL</span>
									</div>
								</div>
		...
		<!-- End Incredible Area -->
		<section class="incredible-area incredible-area-two incredible-area-four ptb-100 jarallax">
			<div class="container">
				...
				<div class="row align-items-center">
					<div class="col-lg-4">
						<div class="footer-logo">
							<img src="assets/img/home-four/footer-logo.png" alt="Image">
						</div>
					</div>
					<div class="col-lg-8">
						<ul>
				...
				<div class="footer-middle-area pt-100 pb-70">
					<div class="row">
							...
							<div class="single-widget">
								...
								<ul class="information">
									...
									<li class="address">
										...
										<span>Email</span>
										<a href="/cdn-cgi/l/email-protection#2d45484141426d484e425f4446034e4240">
											<span class="__cf_email__" data-cfemail="f098959c9c9fb095939f82999bde939f9d">[email&#160;protected]</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-widget">
								<h3>Instagram</h3>
								<ul class="instagram-wrap">
									<li>
										<a href="#"><img src="assets/img/instagram/1.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/2.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/3.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/4.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/5.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/6.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/7.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/8.jpg" alt="Image"></a>
									</li>
									<li>
										<a href="#"><img src="assets/img/instagram/9.jpg" alt="Image"></a>
									</li>
								</ul>
							</div>
						</div>
